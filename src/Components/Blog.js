    ...
    <section className="relBlog" id="blog">
      <div className="blog">
        ...
        <p>
          ...
          weighed which language I wanted touse to tackle Conway's Game of life.
        ...
        <p>
          ...
          right? I made the video loop from a choppier version and really
          smoothed it out and made it pretty seamless. I also created all the
          graphics for this application using Inkscape and Gimp.
        </p>
        <p>
