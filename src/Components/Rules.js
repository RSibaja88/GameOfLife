...
export default function Rules() {
  return (
    <section className="relRules">
      <img className="logo" src={logo} alt="Logo" />
      <div className="relRule" id="rules">
        <div className="rules">
          ...
          <p>
            Each cell with one or no neighbors dies, as if by solitude. Each
            cell with four or more neighbors dies, as if by overpopulation. Each
            cell with two or three neighbors survives.
          </p>
